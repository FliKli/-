...
2.инструментальная среда пользователя.
...
3.1 Взаимосвязь этапов ЖЦПО и ЖЦ системы
Этапы ЖЦПО:
1) анализ требований - совмещается с формированиями требований, разработкой концепции АС и техническим заданием;
2) проектирование - совмещается с ЭП, ТП;
3) кодирование (программирование) и тестирование - совмещается с РД;
4) внедрение - совмещается с вводом в действие;
5) сопровождение - совмещается с сопровождением;
...
Лекция 15 Оценка качества разработанной программной продукци
